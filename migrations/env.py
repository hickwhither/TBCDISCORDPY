...
# Make the URL come from DATABASE_URL (same default as core.database).
DATABASE_URL = os.environ.get("DATABASE_URL", "sqlite+aiosqlite:///data/tbc.db")
...
import features.birthday.models  # noqa: E402, F401
